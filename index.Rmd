...
## Visualize the raw data from past to future
...
## Visualize the periodicities in the data
...
## <span style="color:#FFDAB9"> Systematically explore <span style="color:#FFDAB9">  multiple perspectives of  temporal data <span style="color:#FFDAB9">across <span style="color:Crimson"> deconstructed time <span style="color:#FFDAB9"> through <span style="color:Crimson"> visualization of probability distributions <span style="color:#FFDAB9"> to find regular patterns or anomalies in behaviors.
...
# Challenges : Computation of granularities

 <br>

### Compute any granularity given the hierarchy structure?
 <br>
 <br>
 
### Exhaustive list of granularities to explore?
 <br>
