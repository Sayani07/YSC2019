...
<span style="color:Orange"><large>  So there are $^{15} P_2$ =  `r length(combn(6,2))` pair of granularities to look at.    <span style="color:Red"> -----> <large> </large>
]
]
---
...
```{r harmony}
```
### <span style="color:Orange"><large>  Good news! Only 13 out `r length(combn(6,2))` are harmonies </large>
]
---
