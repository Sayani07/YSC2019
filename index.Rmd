...
#### Tsibble is  a data abstraction for tidy temporal data


<img src="images/tsibble.png", height = "200px">

#### Data structure is an extension of tsibble structure


<img src="images/data-structure.png", height = "200px">
...
<span style="color:Orange"><large>  So there are $^{15} P_2$ =  `r length(combn(15,2))` pair of granularities to look at.    <span style="color:Red"> -----> <large> WHAT??? </large>
]
]
---
...
```{r harmony}
```
### <span style="color:Orange"><large>  Good news! Only 13 out `r length(combn(15,2))` are harmonies </large>
]
---
...
```{r gran-advice}
```
### <span style="color:Orange"><large>  Quantile plots recommended for the first harmony </large>
]
