...
Standard boxplots display a compact distributional summary with median, quartiles and extreme outliers. the number of outliers is larger for larger data set and we do not have an idea if the distribution is multimodal

Violin plots add the information available from local density estimates to summary statistics provided by box plots.  The density in violins are estimated through kernel density estimation and thus makes assumptions when selecting kernel or bandwidth. 
